...
public class PokeTableModel extends DefaultTableModel {
	...
	public Vector<Object[]> getQualifiedPokemonBasedstats(String stat, int base) throws SQLException {
		ResultSet result;
		...
		String query = 
				...
				+ "WHERE s.identifier = " + s + " AND ps.base_stat >= " + base +" AND ps.pokemon_id = p.id AND pt.pokemon_id = p.id AND pt.type_id = t.id"
	...
	public Vector<Object[]> getQualifiedPokemonstatsSum(int sum) throws SQLException {
		ResultSet result;
		String query = 
